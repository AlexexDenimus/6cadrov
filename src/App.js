...
function App() {
  ...
  return (
    <Body>
      ...
      {currentPage === 1 && (
        <Root
          title="Выберите период для рассчёта потребности персонала (A)"
          onClick={handleFirstClick}
          disabled={AType === "" ? true : false}
        >
          <Box>
            <input
              type="radio"
          ...
          <Box>
            ...
            <label htmlFor="choice2">
              Долговременная потребность в специалиста
            </label>
          </Box>
        </Root>
      )}
      {currentPage === 2 && distance === 3 && (
        <Root
          title="Введите данные для вычисления потребности персонала"
          onClick={handleNextClick}
          disabled={isNaN(A) ? true : false}
        >
          <Flex
            flexDirection="row"
            alignItems="center"
          ...
          >
            <label htmlFor="workerCount">
              Среднесписочна численность рабочих
            </label>
            <input
              type="number"
              id="workerCount"
      ...
      {currentPage === 2 && distance === 5 && (
        <Root
          title="Введите данные для вычисления базовой потребности в кадрах"
          onClick={handleNextClick}
      ...
      {currentPage === 3 && distance === 5 && (
        <Root
          title="Для каких целей возникла дополнительная потребность в кадрах"
          onClick={handleNextClick}
          disabled={AType === "" ? true : false}
        >
          <Box>
      ...
      {currentPage === 4 && distance === 5 && AType === "upgrade" && (
        <Root
          title="Введите данные для вычисления дополнительной потребности в кадрах"
        ...
        >
          ...
          >
            <label htmlFor="common">
              Общая потребность в специалистах в планируемый период (Апл)
            </label>
            <input
              type="number"
              id="common"
          ...
          >
            <label htmlFor="basic">
              Общая потребность в специалистах в базовый период (Аб)
            </label>
            <input
              type="number"
              id="basic"
      ...
      {((currentPage === 5 && distance === 5) ||
        (currentPage === 3 && distance === 3)) && (
        <Root
          title="Общая потребность предприятия в кадрах составила:"
          noButton
        >
